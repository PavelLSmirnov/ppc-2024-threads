...
#include "omp/smirnov_p_sort_double_batcher/include/ops_omp.hpp"

TEST(smirnov_p_sort_double_batcher, array) {
  // Create data
  ...
  // Create Task
  SmirnovPavelOmp::RadixSortDoubleBatcherSequential testRDSBSequential(RSDBDataSeq);
  ...
  // Create Task
  SmirnovPavelOmp::RadixSortDoubleBatcherOmpParallel testRDSBompParallel(RSDBDataOmp);
...
TEST(smirnov_p_sort_double_batcher, test_array_2) {
  // Create data
...
TEST(smirnov_p_sort_double_batcher, test_empty) {
  // Create data
...
TEST(smirnov_p_sort_double_batcher, test_one_number) {
  // Create data
...
TEST(smirnov_p_sort_double_batcher, test_with_negative) {
  // Create data
...
TEST(smirnov_p_sort_double_batcher, test_random) {
  // Create data
  std::vector<double> array = SmirnovPavelOmp::randomVector(1000, -1000000, 1000000);
  // Create data
  std::vector<double> out_seq(array.size());
