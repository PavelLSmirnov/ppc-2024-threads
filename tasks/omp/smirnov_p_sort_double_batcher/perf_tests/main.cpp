...
TEST(smirnov_p_sort_double_batcher, test_pipeline_run) {
  // Create data
  std::vector<double> array = SmirnovPavelOmp::randomVector(1000000, -1000000, 1000000);
  ...
  // Create Task
  auto testRSDBompParallel = std::make_shared<SmirnovPavelOmp::RadixSortDoubleBatcherOmpParallel>(RSDBDataOmp);
